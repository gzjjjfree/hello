...
import (
	net "github.com/gzjjjfree/hello/common/net"
	protocol "github.com/gzjjjfree/hello/common/protocol"
...
type ServerConfig struct {
	...
	AuthType   AuthType          `protobuf:"varint,1,opt,name=auth_type,json=authType,proto3,enum=hello.core.proxy.socks.AuthType" json:"auth_type,omitempty"`
...
var file_proxy_socks_config_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x68, 0x65, 0x6c, 0x6c,
	0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x73, 0x6f, 0x63,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72,
	...
	0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65,
	...
	0x72, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x68, 0x65, 0x6c,
	0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70,
	...
	0x4f, 0x52, 0x44, 0x10, 0x01, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x7a, 0x6a, 0x6a, 0x6a, 0x66, 0x72, 0x65, 0x65, 0x2f, 0x68, 0x65,
	0x6c, 0x6c, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2f, 0x73, 0x6f, 0x63, 0x6b, 0x73, 0x62,
...
var file_proxy_socks_config_proto_goTypes = []any{
	(AuthType)(0),                   // 0: hello.core.proxy.socks.AuthType
	(*Account)(nil),                 // 1: hello.core.proxy.socks.Account
	(*ServerConfig)(nil),            // 2: hello.core.proxy.socks.ServerConfig
	(*ClientConfig)(nil),            // 3: hello.core.proxy.socks.ClientConfig
	nil,                             // 4: hello.core.proxy.socks.ServerConfig.AccountsEntry
	(*net.IPOrDomain)(nil),          // 5: hello.core.common.net.IPOrDomain
	(*protocol.ServerEndpoint)(nil), // 6: hello.core.common.protocol.ServerEndpoint
}
var file_proxy_socks_config_proto_depIdxs = []int32{
	0, // 0: hello.core.proxy.socks.ServerConfig.auth_type:type_name -> hello.core.proxy.socks.AuthType
	4, // 1: hello.core.proxy.socks.ServerConfig.accounts:type_name -> hello.core.proxy.socks.ServerConfig.AccountsEntry
	5, // 2: hello.core.proxy.socks.ServerConfig.address:type_name -> hello.core.common.net.IPOrDomain
	6, // 3: hello.core.proxy.socks.ClientConfig.server:type_name -> hello.core.common.protocol.ServerEndpoint
