...
import (
	serial "github.com/gzjjjfree/hello/common/serial"
...
type TransportConfig struct {
	...
	Protocol TransportProtocol `protobuf:"varint,1,opt,name=protocol,proto3,enum=hello.core.transport.internet.TransportProtocol" json:"protocol,omitempty"`
	// Type of network that this settings supports.
	// 此设置支持的网络类型。
...
type SocketConfig struct {
	...
	// TFO 是 TFO 设置的状态。
	Tfo SocketConfig_TCPFastOpenState `protobuf:"varint,2,opt,name=tfo,proto3,enum=hello.core.transport.internet.SocketConfig_TCPFastOpenState" json:"tfo,omitempty"`
	// TProxy is for enabling TProxy socket option.
	// TProxy 用于启用 TProxy 套接字选项。
	Tproxy SocketConfig_TProxyMode `protobuf:"varint,3,opt,name=tproxy,proto3,enum=hello.core.transport.internet.SocketConfig_TProxyMode" json:"tproxy,omitempty"`
...
var file_transport_internet_config_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x1d, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x74, 0x72,
	...
	0x63, 0x6f, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x30, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74,
	...
	0x32, 0x26, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63, 0x6f,
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x30, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63,
	...
	0x6e, 0x67, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x73, 0x65,
	...
	0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x68,
	0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70,
	...
	0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e,
	...
	0x0e, 0x32, 0x36, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x74,
	...
	0x6d, 0x61, 0x69, 0x6e, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x10, 0x05, 0x42, 0x2f, 0x5a, 0x2d,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x7a, 0x6a, 0x6a, 0x6a,
	0x66, 0x72, 0x65, 0x65, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73,
	0x70, 0x6f, 0x72, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x62, 0x06, 0x70,
...
var file_transport_internet_config_proto_goTypes = []any{
	(TransportProtocol)(0),             // 0: hello.core.transport.internet.TransportProtocol
	(SocketConfig_TCPFastOpenState)(0), // 1: hello.core.transport.internet.SocketConfig.TCPFastOpenState
	(SocketConfig_TProxyMode)(0),       // 2: hello.core.transport.internet.SocketConfig.TProxyMode
	(*TransportConfig)(nil),            // 3: hello.core.transport.internet.TransportConfig
	(*StreamConfig)(nil),               // 4: hello.core.transport.internet.StreamConfig
	(*ProxyConfig)(nil),                // 5: hello.core.transport.internet.ProxyConfig
	(*SocketConfig)(nil),               // 6: hello.core.transport.internet.SocketConfig
	(*serial.TypedMessage)(nil),        // 7: hello.core.common.serial.TypedMessage
}
var file_transport_internet_config_proto_depIdxs = []int32{
	0, // 0: hello.core.transport.internet.TransportConfig.protocol:type_name -> hello.core.transport.internet.TransportProtocol
	7, // 1: hello.core.transport.internet.TransportConfig.settings:type_name -> hello.core.common.serial.TypedMessage
	0, // 2: hello.core.transport.internet.StreamConfig.protocol:type_name -> hello.core.transport.internet.TransportProtocol
	3, // 3: hello.core.transport.internet.StreamConfig.transport_settings:type_name -> hello.core.transport.internet.TransportConfig
	7, // 4: hello.core.transport.internet.StreamConfig.security_settings:type_name -> hello.core.common.serial.TypedMessage
	6, // 5: hello.core.transport.internet.StreamConfig.socket_settings:type_name -> hello.core.transport.internet.SocketConfig
	1, // 6: hello.core.transport.internet.SocketConfig.tfo:type_name -> hello.core.transport.internet.SocketConfig.TCPFastOpenState
	2, // 7: hello.core.transport.internet.SocketConfig.tproxy:type_name -> hello.core.transport.internet.SocketConfig.TProxyMode
