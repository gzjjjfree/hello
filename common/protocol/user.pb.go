...
var file_common_protocol_user_proto_rawDesc = []byte{
	...
	0x6c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x68, 0x65,
...
var file_common_protocol_user_proto_goTypes = []any{
	(*User)(nil),                // 0: hello.core.common.protocol.User
	(*serial.TypedMessage)(nil), // 1: hello.core.common.serial.TypedMessage
}
var file_common_protocol_user_proto_depIdxs = []int32{
	1, // 0: hello.core.common.protocol.User.account:type_name -> hello.core.common.serial.TypedMessage
