...
func (af AddressFamily) IsDomain() bool {
	fmt.Println("in common-net-address.go func (af AddressFamily) IsDomain(): ", af)
	fmt.Println("in common-net-address.go func (af AddressFamily) IsDomain(): ", af == AddressFamilyDomain)
...
func DomainAddress(domain string) Address {
	fmt.Println("in common-net-address.go func DomainAddress domain: ", domainAddress(domain))
