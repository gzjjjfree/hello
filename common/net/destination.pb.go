...
type Endpoint struct {
	...
	Network Network     `protobuf:"varint,1,opt,name=network,proto3,enum=hello.core.common.net.Network" json:"network,omitempty"`
...
var file_common_net_destination_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e,
	...
	0x0b, 0x32, 0x21, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x63,
	...
	0x67, 0x7a, 0x6a, 0x6a, 0x6a, 0x66, 0x72, 0x65, 0x65, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2f,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6e, 0x65, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_common_net_destination_proto_goTypes = []any{
	(*Endpoint)(nil),   // 0: hello.core.common.net.Endpoint
	(Network)(0),       // 1: hello.core.common.net.Network
	(*IPOrDomain)(nil), // 2: hello.core.common.net.IPOrDomain
}
var file_common_net_destination_proto_depIdxs = []int32{
	1, // 0: hello.core.common.net.Endpoint.network:type_name -> hello.core.common.net.Network
	2, // 1: hello.core.common.net.Endpoint.address:type_name -> hello.core.common.net.IPOrDomain
