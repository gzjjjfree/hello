...
func ContextWithInbounds(ctx context.Context, inbound *core.InboundHandlerConfig) context.Context {
	return context.WithValue(ctx, inboundsSessionKey, inbound)
}
...
func ContextWithOutbounds(ctx context.Context, outbound *core.OutboundHandlerConfig) context.Context {
	return context.WithValue(ctx, outboundsSessionKey, outbound)
}

func ContextWithDns(ctx context.Context, outbound *core.DnsHandlerConfig) context.Context {
	return context.WithValue(ctx, dnsSessionKey, outbound)
}

func ContextWithRouting(ctx context.Context, outbound *core.RoutingHandlerConfig) context.Context {
	return context.WithValue(ctx, routingSessionKey, outbound)
}
